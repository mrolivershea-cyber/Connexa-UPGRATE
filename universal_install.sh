...
# Версия: 2.4 - FRONTEND С ТАЙМАУТОМ (НЕ БЛОКИРУЕТ УСТАНОВКУ)
...
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                                ║"
echo "║               CONNEXA ADMIN PANEL - УНИВЕРСАЛЬНАЯ УСТАНОВКА v2.4              ║"
echo "║                                                                                ║"
echo "║            🚀 ТАЙМАУТ 3 МИН - ПРОДОЛЖАЕТ ДАЖЕ ЕСЛИ NPM ЗАВИСНЕТ               ║"
echo "║                                                                                ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
sleep 2
