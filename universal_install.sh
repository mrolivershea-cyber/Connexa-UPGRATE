...
# Версия: 3.0 - АВТООПРЕДЕЛЕНИЕ IP + АВТООБНОВЛЕНИЕ .ENV
...
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                                ║"
echo "║               CONNEXA ADMIN PANEL - УНИВЕРСАЛЬНАЯ УСТАНОВКА v3.0              ║"
echo "║                                                                                ║"
echo "║            🚀 АВТООПРЕДЕЛЕНИЕ IP + АВТООБНОВЛЕНИЕ BACKEND URL                 ║"
echo "║                                                                                ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
sleep 2
