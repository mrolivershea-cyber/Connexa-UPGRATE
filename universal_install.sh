...
# Версия: 3.6 - НОВЫЙ РЕПОЗИТОРИЙ + ИСПРАВЛЕН ppp_interface
# Репозиторий: https://github.com/mrolivershea-cyber/10-22-2025-final-fix-auto
##########################################################################################
...
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                                ║"
echo "║               CONNEXA ADMIN PANEL - УНИВЕРСАЛЬНАЯ УСТАНОВКА v3.4              ║"
echo "║                                                                                ║"
echo "║            🚀 FRONTEND ЧЕРЕЗ КИТАЙСКОЕ ЗЕРКАЛО (100% АВТОМАТ)                 ║"
echo "║                                                                                ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
sleep 2
...
if [ -d "$INSTALL_DIR/frontend/node_modules" ] && [ -n "$(ls -A $INSTALL_DIR/frontend/node_modules 2>/dev/null)" ]; then
    ...
    print_warning "Frontend пропущен (node_modules не установлен)"
fi
...
# Frontend проверка только если установлен
