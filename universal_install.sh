...
# Версия: 2.9 - УВЕЛИЧЕН ТАЙМАУТ npm (5 мин) + ОЧИСТКА ПЕРЕД УСТАНОВКОЙ
...
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                                ║"
echo "║               CONNEXA ADMIN PANEL - УНИВЕРСАЛЬНАЯ УСТАНОВКА v2.8              ║"
echo "║                                                                                ║"
echo "║            🚀 АВТООЧИСТКА LOCK + npm --force + itsdangerous                   ║"
echo "║                                                                                ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
sleep 2
