...
# Автоматическая установка с GitHub с пост тапными тестами и проверками
# Версия: 2.2 - ИСПРАВЛЕНА УСТАНОВКА YARN + FALLBACK НА NPM
...
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                                ║"
echo "║               CONNEXA ADMIN PANEL - УНИВЕРСАЛЬНАЯ УСТАНОВКА v2.1              ║"
echo "║                                                                                ║"
echo "║            🚀 100% АВТОМАТИЧЕСКАЯ УСТАНОВКА (БЕЗ ДИАЛОГОВ)                    ║"
echo "║                                                                                ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
sleep 2
