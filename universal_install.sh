...
# Версия: 2.3 - ПОЛНОСТЬЮ БЕЗ YARN, ТОЛЬКО NPM + FALLBACK REGISTRY
...
echo "╔════════════════════════════════════════════════════════════════════════════════╗"
echo "║                                                                                ║"
echo "║               CONNEXA ADMIN PANEL - УНИВЕРСАЛЬНАЯ УСТАНОВКА v2.3              ║"
echo "║                                                                                ║"
echo "║            🚀 БЕЗ YARN - ТОЛЬКО NPM + ЗАЩИТА ОТ СЕТЕВЫХ ПРОБЛЕМ               ║"
echo "║                                                                                ║"
echo "╚════════════════════════════════════════════════════════════════════════════════╝"
echo ""
sleep 2
