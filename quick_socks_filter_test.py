...
login_response = requests.post("https://proxy-route-fix.preview.emergentagent.com/api/auth/login", json=login_data)
...
socks_response = requests.post("https://proxy-route-fix.preview.emergentagent.com/api/socks/start", json=socks_start_data, headers=headers)
...
socks_response = requests.post("https://proxy-route-fix.preview.emergentagent.com/api/socks/stop", json=socks_stop_data, headers=headers)
